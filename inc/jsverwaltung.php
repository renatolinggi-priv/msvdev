...
$(document).ready(function () {
    ...
    // Moderne Toast-Funktion wie in mitgliederverwaltung.php
    ...
    function saveNewJungschuetze(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                try {
                    ...
                    if (result.status === 'success') {
                        showToast('Neuer Jungschütze erfolgreich hinzugefügt!', 'success');
            ...
            error: function(xhr, status, error) {
                showToast('Verbindungsfehler beim Hinzufügen des Jungschützen', 'error');
            },
            complete: function() {
