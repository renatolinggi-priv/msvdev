...
// Lade PDFGenerator aus dem übergeordneten Verzeichnis
...
class ZielscheibeReport extends PDFGenerator {
    ...
    private $customPdfDir = null; // Custom PDF-Ausgabeverzeichnis
    ...
    /**
     * Setze custom PDF-Ausgabeverzeichnis
     */
    ...
    public function generate() {
        ...
        try {
            ...
            // Wenn customPdfDir gesetzt ist, überschreibe temporär das Verzeichnis
            if ($this->customPdfDir) {
                // Speichere den Original-Pfad (falls PDFGenerator ein Property dafür hat)
                // und setze den custom Pfad
    ...
    protected function generatePDFToCustomDir($html, $filename, $orientation = 'portrait', $customDir) {
        ...
        // Erstelle vollständigen Dateinamen mit Timestamp
        ...
        // Verwende dompdf (wie PDFGenerator)
        ...
        // Gebe relativen Pfad zurück (für Browser)
