    ...
    if (count($parts) == 2) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            if ($current_name !== $correct_name) {
                ...
                $stmt_update->execute();
                echo "âœ“ ID $sieger_id: '$current_name' â†’ '$correct_name'\n<br>";
                $updated++;
            } else {
                $already_correct++;
            }
            ...
            if ($result_check2->num_rows > 0) {
                ...
                echo "â—‹ ID $sieger_id: '$current_name' ist bereits korrekt\n<br>";
                $already_correct++;
            } else {

                // Nicht gefunden
                echo "âš  ID $sieger_id: Mitglied nicht gefunden für '$current_name'\n<br>";
                $notFound++;
            }
        }
    } else {
        echo "âš  ID $sieger_id: Kann '$current_name' nicht aufteilen\n<br>";
        $notFound++;
    }
}
