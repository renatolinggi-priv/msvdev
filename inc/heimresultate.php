                    ...
                    <form id="heimresultateForm">
                        ...
                        <div class="table-wrapper">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" id="heimresultateTabelle" style="width:auto;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">Passe 6</th>
                                            <th scope="col" class="text-center">Passe 7</th>
                                            <th scope="col" class="text-center">Passe 8</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
<!-- Einheitliches Modal zur Bestätigung -->
...
$(document).ready(function() {
    // Initialisiere den Manager für Heim-Resultate
