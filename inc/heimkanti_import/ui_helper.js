// heimkanti_import/ui_helper.js – vereinheitlichte UI-Utilities (minimaler Toast ohne Header)
const UIHelper = {
  getToastContainer() {
  ...
  // Minimaler Toast: nur Body + Close, kein Header/Titel
