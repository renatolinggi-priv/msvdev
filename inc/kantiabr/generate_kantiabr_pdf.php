...
<head>
    ...
    <style>
        <?= pdf_theme_css() ?>
        /* Kantonalstich-Abrechnung (SKSG): Layout-Overrides */
        @page { margin: 20px; }
        body { font-size: 12px; margin: 20px; }
        .container { padding: 10px; }
        h2, h3, h4, h5 { text-align: center; margin: 10px 0; color: #2d3748; }
        ...
        .footer { font-size: 8px; bottom: -40px; height: 30px; }
        .page-break { page-break-after: always; }
        .richtigkeit-abschnitt { margin-top: 200px; }
        .abschnitt { margin-top: 80px; }
    </style>
</head>
    ...
    <div class="container">
        ...
        <div class="address">
            <p>Renate Peters<br>
                Büelhof 5<br>
                8852 Altendorf</p>
            <p>Kantonaler Spezialstich 300m<br>MSV Wilen-Wollerau<br>Abrechnung</p>
        </div>
        <table class="table">
            <tr>
        ...
        <p class="richtigkeit-abschnitt">Die Richtigkeit der Abrechnung bescheinigt:</p>
        <p class="abschnitt">Stempel: _______________ Unterschrift: _______________</p>
        <div class="page-break"></div>
        <div class="header flex-header">
            <img src="<?php echo $logoBase64; ?>" alt="Logo" style="width:100px; height:auto; margin-right: 20px;">
