...
include_once '../endschrang/function_date.php';
...
class PDFGenerator {
    ...
    public function __construct($conn, $year = null) {
        ...
        // Logo konvertieren
        $logoPath = '../endschrang/dat/MSVWilen_Logo.jpg';
    ...
    protected function generatePDF($html, $filename, $orientation = 'portrait') {
        ...
        $date = new DateTime();
        $pdfFilePath = wanderpreise_safe_path($filename . '_' . $date->format('Y-m-d_H-i-s') . '.pdf');
    ...
    protected function outputDownloadLink($pdfFilePath) {
        ...
        // absoluten Pfad ab Webroot zurückgeben
